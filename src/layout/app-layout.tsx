...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['project-manager', 'team-member', 'accountant'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Estimate', path: '/estimates', entity: 'estimate', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
