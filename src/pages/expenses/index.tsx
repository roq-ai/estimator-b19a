            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  <Th>description</Th>
                  <Th>amount</Th>
                  {hasAccess('estimate', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>estimate</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('estimate', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/estimates/view/${record.estimate?.id}`}>
                          {record.estimate?.time_plan}
                        </Link>
                      </Td>
                    )}
